...
public class MyServer {
	...
	private void initialize() {
		...
		final JLabel lblServerRunning = new JLabel("Please set the port before start. Change the share directory as you like.");
		...
		try {
			...
			final JButton btnClose = new JButton("Start Server");
			...
			lblNewLabel_2.setBounds(6, 237, 450, 16);
	...
	static class TCPServer implements Runnable {
		...
		private void transfer() {
			try {
				lblNewLabel_2.setText("Start sending at " + System.currentTimeMillis() + "ms");
